module "eks" {
  ...
  # ------------------------------------------------------------------
  # Cluster Security Group(Control Plane + Data Plane)
  # Anything that says just security_group_* = cluster/control-plane.
  # Anything that says node_security_group_* = worker nodes.
  # ------------------------------------------------------------------
      
  ####For cluster security group
  ...
  #### For node security group
  #### The module already creates the node security group with a full set of default rules baked in. 
  #### You didn't write node rules because you don't need to — they come automatically. Tags ≠ rules; they're two completely different things.
  #### Also you don't need to add "create_node_security_group = true" as it already defaults to true in the module.
  node_security_group_tags = {
    "karpenter.sh/discovery" = local.cluster_name
  }

  # ------------------------------------------------------------------
  # Bootstrap Managed Node Groups for Karpenter Pods
  # ------------------------------------------------------------------
